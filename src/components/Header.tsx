        ...
        <nav className="hidden lg:flex items-center space-x-6">
          ...
          <div className="relative group">
            ...
            <div className="absolute top-full left-0 mt-2 w-80 bg-white rounded-lg shadow-xl border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
              <div className="p-3">
                <div className="px-3 py-2 text-xs font-semibold text-gray-500 uppercase tracking-wide border-b border-gray-100 mb-2">Our Solutions</div>
                <Link href="/mini-grids" className="block px-4 py-3 text-sm hover:bg-primary/5 hover:border-l-4 hover:border-l-primary rounded-md transition-all duration-200">
                  ...
                  <div className="text-xs text-gray-600 leading-relaxed">Reliable and sustainable power to off-grid communities</div>
                </Link>
                <Link href="/energy-services" className="block px-4 py-3 text-sm hover:bg-primary/5 hover:border-l-4 hover:border-l-primary rounded-md transition-all duration-200">
                  ...
                  <div className="text-xs text-gray-600 leading-relaxed">Solar solutions for Commercial and Industrial Clients</div>
                </Link>
                <Link href="/energy-management" className="block px-4 py-3 text-sm hover:bg-primary/5 hover:border-l-4 hover:border-l-primary rounded-md transition-all duration-200">
                  ...
                  <div className="text-xs text-gray-600 leading-relaxed">Advisory services, energy audits, and project management</div>
                </Link>
              </div>
            </div>
          </div>
        ...
        <div className="lg:hidden border-t bg-background">
          <div className="container py-4">
            <nav className="flex flex-col space-y-4">
              <Link href="/about" className="text-sm font-medium py-2 hover:text-primary transition-colors">About Us</Link>
              <Link href="/approach" className="text-sm font-medium py-2 hover:text-primary transition-colors">Approach</Link>
              <div>
                <button
                ...
                {isServicesOpen && (
                  <div className="pl-4 mt-3 space-y-1 bg-gray-50 rounded-md p-3 ml-2">
                    <Link href="/mini-grids" className="block text-sm font-medium text-gray-800 hover:text-primary hover:bg-white rounded-md px-3 py-2 transition-colors">
                      <div className="font-medium">Mini-Grids</div>
                      <div className="text-xs text-gray-600 mt-1">Community power solutions</div>
                    </Link>
                    <Link href="/energy-services" className="block text-sm font-medium text-gray-800 hover:text-primary hover:bg-white rounded-md px-3 py-2 transition-colors">
                      <div className="font-medium">Energy Services</div>
                      <div className="text-xs text-gray-600 mt-1">Commercial & industrial solutions</div>
                    </Link>
                    <Link href="/energy-management" className="block text-sm font-medium text-gray-800 hover:text-primary hover:bg-white rounded-md px-3 py-2 transition-colors">
                      <div className="font-medium">Energy Management</div>
                      <div className="text-xs text-gray-600 mt-1">Advisory & project management</div>
                    </Link>
                  </div>
                )}
              </div>
              <Link href="/experience" className="text-sm font-medium py-2 hover:text-primary transition-colors">Experience</Link>
              <Link href="/resources" className="text-sm font-medium py-2 hover:text-primary transition-colors">Resources</Link>
              <Link href="/team" className="text-sm font-medium py-2 hover:text-primary transition-colors">Team</Link>
              <Link href="/careers" className="text-sm font-medium py-2 hover:text-primary transition-colors">Careers</Link>
              <Link href="/blog" className="text-sm font-medium py-2 hover:text-primary transition-colors">Blog</Link>
